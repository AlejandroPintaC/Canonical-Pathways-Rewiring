...
p_snare_expr <- ggplot(SNARE_plot_expr, 
  ...
  scale_color_manual(
    values = setNames(mis_colores[1:n_snare], levels(SNARE_plot_expr$Comunidad)),
    name = "Community"
  ) +
  labs(title = "Average expression vs Degree - SNARE pathway") +
...
ggsave("/Users/alejandropintacastro/Downloads/INMEGEN/IPA/Alejandr@s-EHL/plots mod/SNARE_cambios_cuadricula.png",
       plot = p_snare_expr, width = 12, height = 7, dpi = 300)
