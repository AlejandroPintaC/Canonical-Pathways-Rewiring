...
p_neurexins_expr_cambios <- ggplot(Neurexins_plot_expr, 
  ...
  scale_color_manual(
    values = setNames(mis_colores[1:n_neurex], levels(Neurexins_plot_expr$Comunidad)),
    name = "Community"
  ) +
  labs(title = "Average expression vs Degree - Neurexins and Neuroligins pathway") +
...
ggsave("/Users/alejandropintacastro/Downloads/INMEGEN/IPA/Alejandr@s-EHL/plots mod/Neurexins_cambios_cuadricula.png",
       plot = p_neurexins_expr_cambios, width = 12, height = 7, dpi = 300)
